...
int main() {
  unsigned char input[] = {0x48, 0x65, 0x6C, 0x6C, 0x6F, 0x20, 0x57, 0x6F, 0x72, 0x6C, 0x64, 0x21, 0x21};
  char* output;
  size_t* output_len;
  
  output = encode_bytes_to_base32_string(input, sizeof(input), output_len);
