...
int test_hmac_sha256() {
    return test_hmac(&hmac_sha256, SHA256_HASH_SIZE, tv_sha256_keys, tv_sha256_data, tv_sha256_hash);
}

int test_hmac_sha1() {
    return test_hmac(&hmac_sha1, SHA1_HASH_SIZE, tv_sha1_keys, tv_sha1_data, tv_sha1_hash);
}
